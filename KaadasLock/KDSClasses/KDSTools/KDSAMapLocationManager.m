...
-(void)checkPermissions{
    ...
    if (![KDSTool determineWhetherTheAPPOpensTheLocation]){
        UIAlertController * alerVC = [UIAlertController alertControllerWithTitle:@"温馨提示" message:@"请到设置->隐私->定位服务中开启【凯迪仕智能】定位服务，否则无法添加wifi锁" preferredStyle:UIAlertControllerStyleAlert];
