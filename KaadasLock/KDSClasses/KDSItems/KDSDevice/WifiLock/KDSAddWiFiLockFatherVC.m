...
-(void)addBtnClick:(UIButton *)sender
{
    ...
    NSArray * wifiLockModel = @[@"X1",@"F1",@"K11",@"S110",@"K9-W",@"K10-W",@"K100-W",@"K12",@"K13（兰博）",@"S118",@"A6",@"A7-W",@"A8-W",@"F1S",@"K13F",@"K20F",@"5500-A5P-W",@"5310-A5P-W",@"兰博基尼传奇3D人脸识别智能锁",@"兰博基尼传奇3D人脸识别",@"兰博基尼传奇3D",@"K20-F 3D人脸识别智能锁",@"K20_F 3D人脸识别智能锁",@"K20-F3D人脸识别智能锁",@"K20_F3D人脸识别智能锁",@"K20-F 3D人脸识别",@"K20_F 3D人脸识别",@"K20-F3D人脸识别",@"K20_F3D人脸识别",@"K20-F 3D",@"K20_F 3D",@"K20-F3D",@"K20_F3D",@"K11F",@"K11 Face",@"K11Face"];
    NSArray * bleWifiLockModel = @[@"S110M",@"S110-D1",@"S110-D2",@"S110-D3",@"S110-D4",@"S110D",@"S110 D",@"S110_D",@"S110-D"];
