...
static const NSInteger CDZPickerViewDefaultHeight = 348;
...
- (UIView *)containerView{
    if (!_containerView) {
        ...
        _containerView = [[UIView alloc]initWithFrame:CGRectMake(10, SCREEN_HEIGHT - pickerViewHeight, SCREEN_WIDTH-20, pickerViewHeight)];
...
- (UIButton *)confirmButton{
    if (!_confirmButton) {
        ...
        UIColor *color = self.builder.confirmTextColor ?: KDSRGBColor(31, 150, 247);
...
- (UIPickerView *)pickerView{
    if (!_pickerView) {
        CGFloat pickerViewHeight = self.builder.pickerHeight > CDZToolBarHeight ? self.builder.pickerHeight : CDZPickerViewDefaultHeight;
        _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0,0, SCREEN_WIDTH-20, pickerViewHeight)];
        _pickerView.backgroundColor = UIColor.clearColor;
        _pickerView.layer.masksToBounds = YES;
        _pickerView.layer.cornerRadius = 20;
