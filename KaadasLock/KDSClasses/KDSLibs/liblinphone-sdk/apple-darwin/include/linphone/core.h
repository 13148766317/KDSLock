...
/**
* Get the virtual IP allocated by memenet..
* @return The connection of IP.
*/
LINPHONE_PUBLIC void linphone_core_set_device_ip(LinphoneCore *lc, const char *ip);
    
LINPHONE_PUBLIC char * linphone_core_get_device_ip(void);
