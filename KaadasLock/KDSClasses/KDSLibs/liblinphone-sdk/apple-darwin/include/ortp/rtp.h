...
#define RTP_EXTEND_HEADER_SIZE 4
#define RTP_FEC_HEADER_SIZE 4
#define RTP_FECPKG_SIZE 1408
#define RTP_FECHEAD_SIZE 4
#define RTP_FECPROTECTDATA_NUM 10// ever 10 packets make two fecdata
#define RTP_FECPKG_NUM 2
#define RTP_FECPKG_PT 127
...
typedef struct rtp_stats
{
	...
	uint64_t recv_bind_packets; /*bind packet received */
} rtp_stats_t;
...
#define RTP_SEQ_IS_GREATER_THAN(seq1,seq2)\
