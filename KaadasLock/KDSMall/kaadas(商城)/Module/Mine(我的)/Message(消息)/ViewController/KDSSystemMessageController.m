...
@interface KDSSystemMessageController ()
<
UITableViewDelegate,
...
@implementation KDSSystemMessageController
...
-(void)systemMessageRequest{
    NSString * userToken = [[NSUserDefaults standardUserDefaults] objectForKey:USER_TOKEN];
    NSDictionary * dictionary = @{@"params": @{ @"messageType":@"message_type_system"},
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    KDSSystemMessageCell * cell = [KDSSystemMessageCell systemMessageCellWithTableView:tableView];
...
#pragma mark - 创建UI
-(void)createUI{
    self.navigationBarView.backTitle =@"系统消息";
