...
#import "WPresentController.h"
#define MaskColor [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.7]

@interface WPresentController()
@end
@implementation WPresentController
...
- (void)containerViewWillLayoutSubviews{
    ...
    if (_popoverType == YCPopoverTypeAlert) {
        ...
        self.presentedView.frame = CGRectMake(0, self.containerView.bounds.size.height - self.presentedHeight-MhomeBarH, self.containerView.bounds.size.width, self.presentedHeight);
    }
    //添加蒙版
...
- (UIView *)coverView{
    if (!_coverView) {
        ...
        _coverView.backgroundColor = MaskColor;
