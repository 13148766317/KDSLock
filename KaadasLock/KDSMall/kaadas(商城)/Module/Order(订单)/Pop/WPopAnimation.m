...
@interface WPopAnimation()
{
    BOOL                       _isPresented;
    CGSize                     _presentedSize;
}
@property(nonatomic,strong)WPresentController  *presentationController;
...
- (nullable UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(nullable UIViewController *)presenting sourceViewController:(UIViewController *)source{
    WPresentController *presentation = [[WPresentController alloc] initWithPresentedViewController:presented presentingViewController:presenting];
