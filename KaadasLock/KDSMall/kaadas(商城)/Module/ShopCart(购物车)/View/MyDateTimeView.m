...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
       ...
       btnl = [[CustomBtn alloc]initWithBtnFrame:CGRectMake(80,0, 70, 40) btnType:ButtonImageLeft titleAndImageSpace:10 imageSizeWidth:15 imageSizeHeight:17];
        btnl.titleLabel.font = [UIFont systemFontOfSize:15];
        [btnl setImage:[UIImage imageNamed:@"selectbox_select"] forState:UIControlStateNormal];
        [btnl setTitleColor:[UIColor hx_colorWithHexRGBAString:@"#333333"] forState:UIControlStateNormal];
        [btnl setTitle:@"上午" forState:UIControlStateNormal];
        [btnl addTarget:self action:@selector(amAction:) forControlEvents:UIControlEventTouchUpInside];
        [upVeiw addSubview: btnl];
        
        btnr = [[CustomBtn alloc]initWithBtnFrame:CGRectMake([UIScreen mainScreen].bounds.size.width - 140,0, 70, 40) btnType:ButtonImageLeft titleAndImageSpace:10 imageSizeWidth:15 imageSizeHeight:17];
        btnr.titleLabel.font = [UIFont systemFontOfSize:15];
        [btnr setImage:[UIImage imageNamed:@"产品未选中"] forState:UIControlStateNormal];
        [btnr setTitleColor:[UIColor hx_colorWithHexRGBAString:@"#333333"] forState:UIControlStateNormal];
        [btnr setTitle:@"下午" forState:UIControlStateNormal];
        [btnr addTarget:self action:@selector(amAction:) forControlEvents:UIControlEventTouchUpInside];
        [upVeiw addSubview: btnr];
...
//        [cancelButton setTitleColor:UIColorFromRGB(0x0d8bf5) forState:UIControlStateNormal];
        [cancelButton setTitleColor:[UIColor hx_colorWithHexRGBAString:@"#1F96F7"] forState:UIControlStateNormal];
...
//        [chooseButton setTitleColor:UIColorFromRGB(0x0d8bf5) forState:UIControlStateNormal];
        [chooseButton setTitleColor:[UIColor hx_colorWithHexRGBAString:@"#1F96F7"] forState:UIControlStateNormal];
        ...
        self.field.inputView = self.pickerView;
        self.field.inputAccessoryView = upVeiw;
...
-(void)amAction:(UIButton *)sender{
    if ([sender isEqual:btnl]) {
        [btnl setImage:[UIImage imageNamed:@"selectbox_select"] forState:UIControlStateNormal];
        [btnr setImage:[UIImage imageNamed:@"产品未选中"] forState:UIControlStateNormal];
        apStr = @" 上午";
    }else{
        [btnr setImage:[UIImage imageNamed:@"selectbox_select"] forState:UIControlStateNormal];
        [btnl setImage:[UIImage imageNamed:@"产品未选中"] forState:UIControlStateNormal];
        apStr = @" 下午";
...
//    self.field.text = _string;
//    //新增的
//    if (self.dateBlock) {
//        self.dateBlock(_string);
//    }
    
    self.field.text = [_string stringByAppendingString:apStr];
    //新增的
    if (self.dateBlock) {
        self.dateBlock([_string stringByAppendingString:apStr]);
    }
    
    
//    self.field.text = @"1234";
